...
export const RELATIONSHIP_BY_ANIMAL: Record<Branch, string> = {
  '자': '자(子) 지지의 기운은 언변과 순발력이 좋아 주변 사람들과 빠르게 친해지는 장점이 있습니다.',
  '축': '축(丑) 지지의 기운은 신뢰와 성실함으로 인정받아, 차분한 관계를 오래 유지합니다.',
  '인': '인(寅) 지지의 기운은 주도적이고 도전적인 관계를 선호해, 적극적인 만남에 강합니다.',
  '묘': '묘(卯) 지지의 기운은 배려심과 섬세함이 뛰어나 조화로운 인간관계를 만들기 쉽습니다.',
  '진': '진(辰) 지지의 기운은 카리스마와 호기심이 강해, 다채로운 인연을 끌어들이는 힘이 있습니다.',
  '사': '사(巳) 지지의 기운은 통찰력이 깊어, 사람들의 속마음을 잘 파악하며 관계를 다지는 편입니다.',
  '오': '오(午) 지지의 기운은 밝고 활동적인 분위기로, 네트워크를 넓히고 활기찬 인맥을 유지합니다.',
  '미': '미(未) 지지의 기운은 온화하고 안정적인 기운으로, 서로를 돌보는 관계를 만들기 쉽습니다.',
  '신': '신(申) 지지의 기운은 재치와 아이디어가 풍부해, 협력 속에서 시너지를 내는 관계가 많습니다.',
  '유': '유(酉) 지지의 기운은 성실함과 목표 지향성이 뚜렷해, 함께 성장하는 동료와 잘 맞습니다.',
  '술': '술(戌) 지지의 기운은 의리와 책임감이 강하여, 든든한 동료·파트너로 인정받습니다.',
  '해': '해(亥) 지지의 기운은 포용력과 따뜻함이 있어, 신뢰를 바탕으로한 관계가 오래갑니다.'
}
