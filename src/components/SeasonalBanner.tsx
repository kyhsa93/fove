...
function getSeasonalContent(month: number): SeasonalContent | null {
  switch (month) {
    case 1:
      return {
        title: '신년운세 · 올해의 키워드',
    ...
    case 2:
      return {
        title: '설날 특집 · 가족운',
        subtitle: '토정비결과 가족운을 살펴보고 명절을 준비해보세요.',
        tags: ['토정비결', '가족운'],
        cta: '연간 운세 보기',
        path: ROUTE_PATHS.fortuneYear,
    ...
    case 5:
      return {
        ...
        tags: ['연애운', '결혼운'],
        cta: '궁합 보기',
        path: ROUTE_PATHS.compatibility,
...
export function SeasonalBanner(): JSX.Element | null {
  ...
  const content = getSeasonalContent(month)
